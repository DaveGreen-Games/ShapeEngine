...
namespace Demo.Guns
{
    public class CasingParticle : Particle
    {
        ...
        Raylib_CsLo.Color startColor = WHITE;
        public CasingParticle(Vector2 pos, Vector2 dir, float lifetime, Raylib_CsLo.Color color, float sizeFactor = 1f, float speedFactor = 1f) : base(pos, lifetime)
        {
