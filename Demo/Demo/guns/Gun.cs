...
namespace Demo.Guns
{
    public class Gun
    {
        ...
        public Gun(Vector2 pos, float angle, string gun, Raylib_CsLo.Color color, IDamageable dmgDealer)
        {
            this.pos = pos;
            this.rotRad = angle;
            this.gunName = gun;
        ...
        public Gun(Vector2 pos, Vector2 dir, string gun, Raylib_CsLo.Color color, IDamageable dmgDealer)
        {
            this.pos = pos;
        ...
        public Gun(string gun, Raylib_CsLo.Color color, IDamageable dmgDealer)
        {
            this.gunName = gun;
            this.dmgDealer = dmgDealer;
            this.color = color;
