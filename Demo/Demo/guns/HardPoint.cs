...
namespace Demo.Guns
{
    public class Hardpoint
    {
        ...
        protected Raylib_CsLo.Color color = WHITE;
        protected Raylib_CsLo.Color offColor = WHITE;
        ...
        public Hardpoint(Vector2 offset, Raylib_CsLo.Color color, Raylib_CsLo.Color offColor, float rotOffsetRad, float targetingRange, HardpointType type = HardpointType.FIXED, HardpointSize size = HardpointSize.SMALL)
        {
            this.type = type;
            this.size = size;
            this.color = color;
        ...
        public Hardpoint(Vector2 offset, Raylib_CsLo.Color color, Raylib_CsLo.Color offColor, float rotOffsetRad, float targetingRange, Core energyCore, TargetFinder? targetFinder = null, HardpointType type = HardpointType.FIXED, HardpointSize size = HardpointSize.SMALL)
        {
            this.type = type;
            this.size = size;
            this.color = color;
        ...
        public void Draw()
        {
            ...
            Raylib_CsLo.Color drawColor = color;
            ...
            else
            {
                ...
                {
                    var target = targetFinder.GetTarget();
                    Raylib_CsLo.Color targetColor = SColor.ChangeAlpha(Demo.PALETTES.C(ColorIDs.Enemy), 125);
                    ...
                    DrawRectangleLinesEx(rect, 1f, Demo.PALETTES.C(ColorIDs.Enemy));
                    DrawLineEx(pos, targetPos, 1f, Demo.PALETTES.C(ColorIDs.Enemy));
                }
            }
        }
