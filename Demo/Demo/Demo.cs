...
namespace Demo
{
    ...
    public class CursorGame : ICursor
    {
        ...
        public void Draw(Vector2 uiSize, Vector2 mousePos)
        {
            Raylib_CsLo.Color color = Demo.PALETTES.C(colorID);
    ...
    public class Demo : GameLoop
    {
        ...
        public override void Start()
        {
            ...
            DataContainerCDB dataContainer = new(new global::Demo.DataObjects.DefaultDataResolver(), dataString, "asteroids", "player", "guns", "projectiles", "colors", "engines");
            ...
            foreach (var palette in colorData)
            {
                ...
                Dictionary<uint, Raylib_CsLo.Color> colors = new()
                {
