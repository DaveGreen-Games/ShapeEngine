...
namespace Demo.Bodies
{
    ...
    class AsteroidDeathEffect : SquareEffect
    {
        ...
        public AsteroidDeathEffect(Vector2 pos, float duration, float size, Raylib_CsLo.Color color) : base(pos, duration * 0.8f, size, color, 0f)
        {
    ...
    public class Asteroid : Body
    {
        ...
        public override void WasDamaged(DamageInfo info)
        {
            ...
            Raylib_CsLo.Color particleColor = Demo.PALETTES.C(ColorIDs.Neutral);
