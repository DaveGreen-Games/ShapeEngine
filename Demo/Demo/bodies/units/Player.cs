...
namespace Demo.Bodies
{
    ...
    public class Pin
    {
        ...
        public void Draw()
        {
            ...
            {
                Raylib_CsLo.Color color = Demo.PALETTES.C(ColorIDs.Special1);
    ...
    public class Player : Unit
    {
        ...
        public override void WasDamaged(DamageInfo info)
        {
            ...
            int amount = (int)(50 * f);
            Raylib_CsLo.Color particleColor = Demo.PALETTES.C(ColorIDs.Player);
        ...
        public override void Update(float dt)
        {
            ...
            Raylib_CsLo.Color drawColor = Demo.PALETTES.C(ColorIDs.Player);
        ...
        {
            Raylib_CsLo.Color color = Demo.PALETTES.C(ColorIDs.Player);
            Raylib_CsLo.Color offColor = Demo.PALETTES.C(ColorIDs.Energy);
