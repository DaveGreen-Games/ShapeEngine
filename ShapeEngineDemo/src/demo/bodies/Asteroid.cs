...
namespace ShapeEngineDemo.Bodies
{
    ...
    public class Asteroid : Body
    {
        ...
        public override void WasDamaged(DamageInfo info)
        {
            ...
            var textEffect = new TextEffectEaseSize(pos, text, 1f, WHITE, new Vector2(0.05f, 0.05f), new(0f), 1, ShapeEngineCore.Globals.UI.Alignement.CENTER, 1f, EasingType.BACK_IN);
