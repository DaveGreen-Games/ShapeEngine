...
public sealed class InputTypeMousePositionDelta : IInputType
{
    ...
    /// <inheritdoc/>
    public InputState GetState(GamepadDevice? gamepad = null) => ShapeInput.Mouse.CreateInputState(axis, CurTargetPosition, deadzone, modifierKeySet);

    /// <inheritdoc/>
    public InputState GetState(InputState prev, GamepadDevice? gamepad = null) => ShapeInput.Mouse.CreateInputState(axis, CurTargetPosition, prev, deadzone, modifierKeySet);
