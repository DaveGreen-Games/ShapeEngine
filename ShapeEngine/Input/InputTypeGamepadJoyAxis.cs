...
public sealed class InputTypeGamepadJoyAxis : IInputType
{
    ...
    /// </summary>
    /// <param name="deadzone">The deadzone value. Input values below this threshold are ignored. Default is 0.1f.</param>
    ...
    public static InputTypeGamepadJoyAxis CreateLeftX(float deadzone = 0.1f,  ModifierKeySet? modifierKeySet = null) => new (ShapeGamepadJoyAxis.LEFT_X, deadzone, modifierKeySet);
    ...
    public static InputTypeGamepadJoyAxis CreateLeftY(float deadzone = 0.1f,  ModifierKeySet? modifierKeySet = null) => new (ShapeGamepadJoyAxis.LEFT_Y, deadzone, modifierKeySet);
    ...
    public static InputTypeGamepadJoyAxis CreateRightX(float deadzone = 0.1f,  ModifierKeySet? modifierKeySet = null) => new (ShapeGamepadJoyAxis.RIGHT_X, deadzone, modifierKeySet);
    ...
    public static InputTypeGamepadJoyAxis CreateRightY(float deadzone = 0.1f,  ModifierKeySet? modifierKeySet = null) => new (ShapeGamepadJoyAxis.RIGHT_Y, deadzone, modifierKeySet);
    ...
    /// <param name="deadzone">The deadzone value. Input values below this threshold are ignored. Default is 0.1f.</param>
    /// <param name="modifierKeySet">An optional set of modifier keys to apply to this input type.</param>
    public InputTypeGamepadJoyAxis(ShapeGamepadJoyAxis axis, float deadzone = 0.1f,  ModifierKeySet? modifierKeySet = null)
    {
        this.axis = axis; 
    ...
    /// <inheritdoc/>
    public IInputType Copy() => new InputTypeGamepadJoyAxis(axis, deadzone, modifierKeySet?.Copy());
