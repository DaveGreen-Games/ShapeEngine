...
public static class ShapePhysics
{
    ...
    public static Vector2 CalculateFriction(Vector2 velocity, float mass, float frictionCoefficient, Vector2 frictionNormal, Vector2 gravitationForce)
    {
        // Normalize the frictionNormal vector
        Vector2 normalizedFrictionNormal = Vector2.Normalize(frictionNormal);
