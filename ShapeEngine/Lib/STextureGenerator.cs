...
namespace ShapeEngine.Lib
{
    public static class STextureGenerator
    {
        ...
        public static RenderTexture DrawAction(int w, int h, Raylib_CsLo.Color bgColor, Action drawAction)
        {
        ...
        public static RenderTexture Circle(int radius, Raylib_CsLo.Color color)
        {
            int w = radius * 2;
            int h = radius * 2;
            RenderTexture rt = LoadRenderTexture(w, h);
        ...
        public static RenderTexture GenerateCheckeredLineCircle(float radius, float spacing, float lineThickness, float angleDeg, Raylib_CsLo.Color lineColor, Raylib_CsLo.Color bgColor)
        {
        ...
        public static RenderTexture GenerateCheckeredLinesRect(Vector2 size, float spacing, float lineThickness, float angleDeg, Raylib_CsLo.Color lineColor, Raylib_CsLo.Color bgColor)
        {
        ...
        public static void Stamp(Texture texture, Vector2 pos, float rotDeg, float scale, Raylib_CsLo.Color tint, Vector2 alignement)
        {
