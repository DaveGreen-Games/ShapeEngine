...
namespace ShapeEngine.Color
{
    ...
    public class PaletteHandler
    {
        ...
        public Raylib_CsLo.Color C(uint id) { return CurPalette != null ? CurPalette.Get(id) : WHITE; }
        ...
        public void AddPalette(uint paletteID, Raylib_CsLo.Color[] colors, uint[] ids)
        {
        ...
        public void AddPalette(uint paletteID, params (uint id, Raylib_CsLo.Color color)[] entries)
        {
        ...
        public void AddPalette(uint paletteID, Dictionary<uint, Raylib_CsLo.Color> palette)
        {
