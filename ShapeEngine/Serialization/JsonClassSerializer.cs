...
public class JsonClassSerializer<T> where T : class
{
    ...
    /// <returns>A JSON string representation of the object.</returns>
    public static string SerializeStatic<TS>(TS instance, JsonSerializerOptions? options = null) where TS : class
    {
    ...
    /// <param name="options">Optional serializer options. If null, default options are used.</param>
    /// <returns>A list of JSON string representations of the objects.</returns>
    public static List<string> SerializeStatic<TS>(List<TS> instances, JsonSerializerOptions? options = null) where TS : class
    {
        options ??= new JsonSerializerOptions
        {
            PropertyNamingPolicy = null,
    ...
    /// <param name="options">Optional serializer options. If null, default options are used.</param>
    /// <returns>The deserialized object, or null if deserialization fails.</returns>
    public static TS? DeserializeStatic<TS>(string json, JsonSerializerOptions? options = null) where TS : class
    {
        options ??= new JsonSerializerOptions
        {
            PropertyNamingPolicy = null,
    ...
    public static List<TS> SerializeStatic<TS>(List<string> jsons, JsonSerializerOptions? options = null) where TS : class
    {
        options ??= new JsonSerializerOptions
        {
            PropertyNamingPolicy = null,
