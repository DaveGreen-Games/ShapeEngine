...
public readonly struct ValueRange : IEquatable<ValueRange>, IComparable<ValueRange>
{
    ...
    public ulong GetHashKey(int decimalPlaces = DecimalPrecision.DefaultDecimalPlaces)
    {
        ...
        return hashQuantizer.GetHash(Min, Max);
    }

    /// <summary>
    /// Creates a fixed-width hexadecimal string representation of this value range hash key.
    /// </summary>
    /// <param name="decimalPlaces">The number of decimal places used to quantize range values before hashing.</param>
    ...
    /// <summary>
    /// Creates a string representation of this value range hash key.
    /// </summary>
    /// <param name="decimalPlaces">The number of decimal places used to quantize range values before hashing.</param>
    ...
    /// <summary>
    /// Returns a hash code for the current <see cref="ValueRange"/> based on its stable quantized hash key.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    /// <returns>A 32-bit hash code representing this range.</returns>
