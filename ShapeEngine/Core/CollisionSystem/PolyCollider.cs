...
public class PolyCollider : Collider
{
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PolyCollider"/> with a set of relative points.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PolyCollider"/> with a relative polygon.
    /// </summary>
    /// <param name="offset">The transform offset for the collider.</param>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="PolyCollider"/> from a segment, inflating it to a polygon.
    /// </summary>
    /// <param name="offset">The transform offset for the collider.</param>
