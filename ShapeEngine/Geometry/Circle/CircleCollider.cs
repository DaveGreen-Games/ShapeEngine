...
public class CircleCollider : Collider
{
    ...
    public override Rect.Rect GetBoundingBox() => GetCircleShape().GetBoundingBox();
    /// <summary>
    ...
    public override Geometry.Circle.Circle GetCircleShape() => new(CurTransform.Position, CurTransform.ScaledSize.Radius);
}