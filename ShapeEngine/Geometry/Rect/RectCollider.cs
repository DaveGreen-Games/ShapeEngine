...
public class RectCollider : Collider
{
    ...
    public override Geometry.Rect.Rect GetBoundingBox() => GetRectShape();
    /// <summary>
    ...
    public override Geometry.Rect.Rect GetRectShape() => new(CurTransform.Position, CurTransform.ScaledSize, Alignement);
}