...
public readonly partial struct Rect : IEquatable<Rect>
{
    ...
    public Segment.Segment LeftSegment => new(TopLeft, BottomLeft);
    public Segment.Segment BottomSegment => new(BottomLeft, BottomRight);
    public Segment.Segment RightSegment => new(BottomRight, TopRight);
    public Segment.Segment TopSegment => new(TopRight, TopLeft);
    ...
    /// </summary>
    /// <returns></returns>
    public Polygon.Polygon GetPointsRelative(Vector2 pos)
    {
