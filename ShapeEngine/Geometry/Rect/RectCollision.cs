...
{
    public (bool outOfBounds, Vector2 newPos) BoundsWrapAround(Circle.Circle boundingCircle)
    {
    ...
    public BoundsCollisionInfo BoundsCollision(Circle.Circle boundingCircle)
    {
        var pos = boundingCircle.Center;
        var radius = boundingCircle.Radius;
