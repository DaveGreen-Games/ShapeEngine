...
public class SegmentCollider : Collider
{
    ...
    /// <param name="originOffset">The origin offset (0=start, 0.5=center, 1=end).</param>
    public SegmentCollider(Geometry.Segment.Segment segment, Vector2 parentPosition, float originOffset = 0f)
    {
    ...
    public override Rect.Rect GetBoundingBox() => GetSegmentShape().GetBoundingBox();
    /// <summary>
    ...
    public override Geometry.Segment.Segment GetSegmentShape() => new(Start, End);
}