...
public static class QuadDrawing
{
    ...
    public static void DrawLinesPercentage(this Quad quad, float f, int startIndex, LineDrawingInfo lineInfo)
    {
        quad.DrawLinesPercentage(f, startIndex, lineInfo.Thickness, lineInfo.Color);
    }
    
    public static void DrawLinesPercentage(this Quad quad, float f, int startIndex, float lineThickness, ColorRgba color)
    {
    ...
    //TODO: Rework with ClipperImmediate2d
    ...
    private static void DrawChamferedOutline(float lineThickness, ColorRgba color)
    {
        ...
        InsetConvex(innerChamferPointsHelper, lineThickness, innerChamferPointsInsetResult, innerChamferPointsInsetBuffer);
        ...
        TriangulateConvexOutline(outerChamferPointsHelper, innerChamferPointsInsetResult, chamferedOutlineTriangulationResultVertices, chamferedOutlineTriangulationResultIndices);
    ...
    //TODO: Remvoe - Use new ClipperImmediate2d class instead of those functions!
    ...
    /// Thread-safe.
    /// </summary>
    private static List<Vector2> InsetConvex(IReadOnlyList<Vector2> poly, float inset, float eps = 1e-6f)
    {
    ...
    /// </summary>
    private static bool InsetConvex(IReadOnlyList<Vector2> poly, float inset, List<Vector2> result, List<Vector2> temp, float eps = 1e-6f)
    {
        if (poly == null) throw new ArgumentNullException(nameof(poly));
    ...
    private static bool TriangulateConvexOutline(IReadOnlyList<Vector2> outerCCW, IReadOnlyList<Vector2> innerCCW, List<Vector2> vertices, List<int> indices, float eps = 1e-6f)
    {
