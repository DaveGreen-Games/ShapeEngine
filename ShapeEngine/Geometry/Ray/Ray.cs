...
public readonly struct Ray
{
    ...
    public static CollisionPoints? IntersectRaySegments(Vector2 rayPoint, Vector2 rayDirection, List<Segment.Segment> segments, int maxCollisionPoints = -1)
    {
    ...
    public CollisionPoint IntersectSegment(Segment.Segment segment) => IntersectRaySegment(Point, Direction, segment.Start, segment.End, segment.Normal);
    ...
    public CollisionPoint IntersectLine(Line.Line line) => IntersectRayLine(Point, Direction, line.Point, line.Direction, line.Normal);
    ...
    public (CollisionPoint a, CollisionPoint b) IntersectCircle(Circle.Circle circle) => IntersectRayCircle(Point, Direction, circle.Center, circle.Radius);
    ...
    public (CollisionPoint a, CollisionPoint b) IntersectTriangle(Triangle.Triangle triangle) => IntersectRayTriangle(Point, Direction, triangle.A, triangle.B, triangle.C);
    ...
    public (CollisionPoint a, CollisionPoint b) IntersectQuad(Quad.Quad quad) => IntersectRayQuad(Point, Direction, quad.A, quad.B, quad.C, quad.D);
    ...
    public (CollisionPoint a, CollisionPoint b) IntersectRect(Rect.Rect rect) => IntersectRayQuad(Point, Direction, rect.A, rect.B, rect.C, rect.D);
    ...
    public CollisionPoints? IntersectPolygon(Polygon.Polygon polygon, int maxCollisionPoints = -1) => IntersectRayPolygon(Point, Direction, polygon, maxCollisionPoints);
    ...
    public CollisionPoints? IntersectPolyline(Polyline.Polyline polyline, int maxCollisionPoints = -1) => IntersectRayPolyline(Point, Direction, polyline, maxCollisionPoints);
    public CollisionPoints? IntersectSegments(List<Segment.Segment> segments, int maxCollisionPoints = -1) => IntersectRaySegments(Point, Direction, segments, maxCollisionPoints);
    ...
    public CollisionPoints? IntersectShape(Line.Line line)
    {
