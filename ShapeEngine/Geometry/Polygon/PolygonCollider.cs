...
public class PolygonCollider : Collider
{
    ...
    /// </summary>
    public Geometry.Polygon.Polygon RelativeShape;
    /// <summary>
    /// The polygon shape in world (absolute) space.
    /// </summary>
    private readonly Geometry.Polygon.Polygon shape;
    ...
    public PolygonCollider(Transform2D offset, Points.Points relativePoints) : base(offset)
    {
    ...
    public PolygonCollider(Transform2D offset, Geometry.Polygon.Polygon relativePoints) : base(offset)
    {
    ...
    public PolygonCollider(Transform2D offset, Segment.Segment s, float inflation, float alignement = 0.5f) : base(offset)
    {
    ...
    public override Geometry.Polygon.Polygon GetPolygonShape() => shape;
}
