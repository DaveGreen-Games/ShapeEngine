...
public class PolygonShape : ShapeContainer
{
    ...
    public PolygonShape(Transform2D offset, Points.Points relativePoints)
    {
        Offset = offset;
    ...
    /// </remarks>
    public PolygonShape(Transform2D offset, Segment.Segment s, float inflation, float alignement = 0.5f)
    {
        Offset = offset;
