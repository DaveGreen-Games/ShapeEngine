...
public readonly partial struct Segment
{
    ...
    /// <returns>A tuple containing the <see cref="CollisionPoint"/> and the intersection time along the first segment, or -1 if no intersection.</returns>
    ...
    /// <returns>A tuple containing the <see cref="CollisionPoint"/> and the intersection time along the segment, or -1 if no intersection.</returns>
