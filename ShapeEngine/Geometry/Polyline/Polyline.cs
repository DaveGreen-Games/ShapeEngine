...
public class Polyline : Points.Points, IEquatable<Polyline>
{
    #region Constructors
    public Polyline() { }
    ...
    public Polyline(Points.Points points) : base(points.Count) { AddRange(points); }
    public Polyline(Polyline polyLine) : base(polyLine.Count) { AddRange(polyLine); }
    public Polyline(Polygon.Polygon poly) : base(poly.Count) { AddRange(poly); }
    #endregion
    ...
    public Points.Points ToPoints() { return new(this); }
    ...
    #region Closest Point
        ...
        public new ClosestPointResult GetClosestPoint(Polygon.Polygon other)
        {
            if (Count < 2) return new();
    ...
    {
        return Segment.Segment.OverlapSegmentPolyline(segmentStart, segmentEnd, points);
    }
    ...
    public static bool OverlapPolylineSegments(List<Vector2> points, List<Segment.Segment> segments)
    {
    ...
    public CollisionPoints? IntersectShape(Ray.Ray ray)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            var result = Segment.Segment.IntersectSegmentRay(this[i], this[i + 1], ray.Point, ray.Direction, ray.Normal);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Line.Line l)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            var result = Segment.Segment.IntersectSegmentLine(this[i], this[i + 1], l.Point, l.Direction, l.Normal);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Segment.Segment s)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            var result = Segment.Segment.IntersectSegmentSegment(this[i], this[i + 1], s.Start, s.End);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Circle.Circle c)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            var result = Segment.Segment.IntersectSegmentCircle(this[i], this[i + 1], c.Center, c.Radius);
    ...
    public CollisionPoints? IntersectShape(Triangle.Triangle t)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            var p1 = this[i];
            var p2 = this[i + 1];
            var result = Segment.Segment.IntersectSegmentSegment(p1, p2, t.A, t.B);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, t.B, t.C);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, t.C, t.A);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Rect.Rect r)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            var p1 = this[i];
            var p2 = this[i + 1];
            var result = Segment.Segment.IntersectSegmentSegment(p1, p2, a, b);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, b, c);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, c, d);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, d, a);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Quad.Quad q)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            var p1 = this[i];
            var p2 = this[i + 1];
            var result = Segment.Segment.IntersectSegmentSegment(p1, p2, q.A, q.B);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, q.B, q.C);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, q.C, q.D);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
            ...
            result = Segment.Segment.IntersectSegmentSegment(p1, p2, q.D, q.A);
            if (result.Valid)
            {
                points ??= new();
                points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Polygon.Polygon p)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            ...
            {
                var result = Segment.Segment.IntersectSegmentSegment(this[i], this[i + 1],p[j], p[(j + 1) % p.Count]);
                if (result.Valid)
                {
                    points ??= new();
                    points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Polyline pl)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            ...
            {
                var result = Segment.Segment.IntersectSegmentSegment(this[i], this[i + 1],pl[j], pl[j + 1]);
                if (result.Valid)
                {
                    points ??= new();
                    points.Add(result);
    ...
    public CollisionPoints? IntersectShape(Segments.Segments segments)
    {
        ...
        for (var i = 0; i < Count - 1; i++)
        {
            foreach (var seg in segments)
            {
                var result = Segment.Segment.IntersectSegmentSegment(this[i], this[i + 1],seg.Start, seg.End);
                if (result.Valid)
                {
                    points ??= new();
                    points.Add(result);
    ...
    /// <returns></returns>
    public Points.Points? InterpolatedEdgePoints(float t)
    {
        if (Count < 2) return null;

        var result = new Points.Points();
        for (int i = 0; i < Count - 1; i++)
        {
            var cur = this[i];
            var next = this[i + 1];
    ...
    /// <returns></returns>
    public Points.Points? InterpolatedEdgePoints(float t, int steps)
    {
        if (Count < 2) return null;
    ...
    #region Static
    public static Polyline GetShape(Points.Points relative, Transform2D transform)
    {
