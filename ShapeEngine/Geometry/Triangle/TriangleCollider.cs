...
public class TriangleCollider : Collider
{
    ...
    public override Rect.Rect GetBoundingBox() => GetTriangleShape().GetBoundingBox();
    /// <summary>
    ...
    public override Geometry.Triangle.Triangle GetTriangleShape() => new(AAbsolute, BAbsolute, CAbsolute);
}
