...
internal class Autogun
{
    ...
    public void Draw()
    {
        if (curTarget != null)
        {
            ...
            pos.Draw(5f, c);
            targetPos.Draw(5f, c);
            ShapeSegmentDrawing.DrawSegment(pos, pos + ShapeVec.VecFromAngleRad(aimingRotRad) * 50, new LineDrawingInfo(8f, c));
            ShapeSegmentDrawing.DrawSegment(pos, targetPos, new LineDrawingInfo(2f, c));
