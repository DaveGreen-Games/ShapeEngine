...
internal class TurretPayload : IPayload
{
    ...
    public void Draw()
    {
        if (landed)
        {
            ...
            ShapeCircleDrawing.DrawCircleLines(targetLocation, info.Size, 6f, Colors.PcCold.ColorRgba, 6);
        ...
        {
            var f = TravelF;
            ShapeCircleDrawing.DrawCircle(targetLocation, 12f, Colors.PcCold.ColorRgba, 24);
            ShapeCircleDrawing.DrawCircleLines(targetLocation, info.ImpactSize * (1f - f), 6f, Colors.PcMedium.ColorRgba, 6);
            ...
            ShapeSegmentDrawing.DrawSegment(lineStart, lineEnd, 24f * f, Colors.PcCold.ColorRgba);
        }
