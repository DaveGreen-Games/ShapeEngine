...
internal class PathfinderFlag(Vector2 pos, float r)
{
    private Circle circle = new(pos, r);
...
public class PathfinderExample : ExampleScene
{
    ...
    private Circle? connectionCircleA;
    private Circle? connectionCircleB;
