...
public class DataExample : ExampleScene
{
    ...
    private class ImpactSmoke
    {
        ...
        public void Draw()
        {
            ...
            ShapeDrawing.DrawCircle(pos, ShapeMath.LerpFloat(size * 0.5f, size, f), c, 24);
        }
    }
    ...
    protected override void OnDrawGameExample(ScreenInfo game)
    {
        ...
        ShapeDrawing.DrawCircleLines(planet.Shape.Center, AsteroidSpawnRadius, 12f, Colors.Highlight, 4f);
