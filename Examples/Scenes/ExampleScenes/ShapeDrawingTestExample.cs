...
public class ShapeDrawingTestExample : ExampleScene
{
    ...
    private void BuildCases()
    {
        ...
        [
            ...
            new("Draw Lines Perimeter", () => polygon.DrawLinesPerimeter(polygon.GetPerimeter() * Percentage, StartIndex, LineThickness, DrawColor, LineCapType.Capped, MiterLimit), ParamId.Thickness, ParamId.Percentage, ParamId.StartIndex, ParamId.MiterLimit),
            new("Draw Lines Percentage", () => polygon.DrawLinesPercentage(Percentage, StartIndex, LineThickness, DrawColor, LineCapType.Capped, MiterLimit), ParamId.Thickness, ParamId.Percentage, ParamId.StartIndex, ParamId.MiterLimit),
