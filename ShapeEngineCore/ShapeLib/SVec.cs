...
namespace ShapeLib
{
    public static class SVec
    {
        ...
        {
            return VecFromAngleRad(angleDeg * RayMath.DEG2RAD);
        }
        //Projection
        ...
        {
            float angleA = SVec.AngleRad(a);
            float angle = SUtils.GetShortestAngleRad(angleA, SVec.AngleRad(b));
            return SVec.Rotate(a, SUtils.LerpFloat(0, angle, t));
        }
        public static Vector2 Lerp(Vector2 v1, Vector2 v2, float t) { return Vector2.Lerp(v1, v2, t); } //RayMath.Vector2Lerp(v1, v2, t);
        public static Vector2 MoveTowards(Vector2 v, Vector2 target, float maxDistance) { return RayMath.Vector2MoveTowards(v, target, maxDistance); }
        ...
        public static Vector2 Normalize(Vector2 v) { return RayMath.Vector2Normalize(v); }//return Vector2.Normalize(v); } //Vector2 normalize returns NaN sometimes???
        public static Vector2 Reflect(Vector2 v, Vector2 n) { return Vector2.Reflect(v, n); } //RayMath.Vector2Reflect(v, n);
        public static Vector2 Scale(Vector2 v, float amount) { return RayMath.Vector2Scale(v, amount); }
        ...
        {
            return AngleRad(v) * RayMath.RAD2DEG;
        }
        public static float AngleRad(Vector2 v) { return AngleRad(Zero(), v); }
        public static float AngleRad(Vector2 v1, Vector2 v2) { return RayMath.Vector2Angle(v1, v2); }
