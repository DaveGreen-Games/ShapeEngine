...
namespace ShapeLib
{
    ...
    */
    public class SColorPalette
    {
        private string name = "";
        private Dictionary<string, Color> palette = new();

        public SColorPalette(string paletteName) { this.name = paletteName; }
        public SColorPalette(string paletteName, params (string name, Color color)[] entries)
        {
        ...
        public SColorPalette(string paletteName, Color[] colors, string[] names)
        {
            this.name = paletteName;
        ...
        public SColorPalette(string paletteName, string[] hexColors, string[] names)
        {
            this.name = paletteName;
            for (int i = 0; i < names.Length; i++)
            {
        ...
        public SColorPalette(string paletteName, Dictionary<string, Color> palette)
        {
            this.name = paletteName;
    ...
    {
        private static Dictionary<string, SColorPalette> palettes = new();
        private static int curPaletteIndex = 0;
        private static List<string> paletteNames = new() { };
        private static SColorPalette curPalette = new SColorPalette("default", 
        ...
        public static SColorPalette Cur { get { return curPalette; } }
        ...
        {
            SColorPalette cp = new(paletteName, hexColors, names);
        ...
        {
            SColorPalette cp = new(paletteName, colors, names);
            if (palettes.ContainsKey(paletteName)) palettes[paletteName] = cp;
            else
            {
                palettes.Add(paletteName, cp);
        ...
        {
            SColorPalette cp = new(paletteName, entries);
            if (palettes.ContainsKey(paletteName)) palettes[paletteName] = cp;
            else
            {
                palettes.Add(paletteName, cp);
        ...
        {
            SColorPalette cp = new(paletteName, palette);
            if (palettes.ContainsKey(paletteName)) palettes[paletteName] = cp;
            else
            {
                palettes.Add(paletteName, cp);
        ...
        public static void AddPalette(SColorPalette palette)
        {
        ...
        /// <param name="colorCount">How many colors there are in the image. </param>
        /// <returns></returns>
        public static SColorPalette GeneratePaletteFromImage(string paletteName, Image source, params string[] colorNames)
        {
        ...
        public static SColorPalette GeneratePalette(string paletteName, int[] colors, params string[] colorNames)
        {
            return new(paletteName, GeneratePalette(colors, colorNames));
        }
        public static SColorPalette GeneratePalette(string paletteName, string[] hexColors, params string[] colorNames)
        {
